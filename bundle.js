...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameAPIEvents = __webpack_require__(10);
	var gameBoard = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateGame = function onCreateGame() {
	  if (globalJS.globalVars.playerLogin === true) {
	    var data = '';
	    gameApi.createGame(data).then(gameUi.createGameSuccess).catch(gameUi.createGameFailure);
	  } else {
	...
	var onJoinGame = function onJoinGame() {
	  if (globalJS.globalVars.playerLogin === true && globalJS.globalVars.createGameSuccess === true) {
	    var data = '';
	    gameApi.joinGame(data).then(gameUi.joinGameSuccess).catch(gameUi.joinGameFailure);
	  } else {
	...
	var updateGameState = function updateGameState(data) {
	  gameApi.updateGame(data).then(gameUi.updateGameSuccess).catch(gameUi.updateGameFailure);
	};
	...
	var onGetStats = function onGetStats(event) {
	  event.preventDefault();
	  var gameId = $('#get-stats').val();
	  if (gameId.length === 0) {
	    gameApi.gameIndex().then(gameUi.gameIndexSuccess).catch(gameUi.gameStatsError);
	  } else {
	    gameApi.gameShow(gameId).then(gameUi.gameShowSuccess).catch(gameUi.gameStatsError);
	  }
	};

	// Provide some summary statistics to user upon request
	var onGetSumStats = function onGetSumStats(event) {
	  event.preventDefault();
	  gameApi.gameIndex().then(gameUi.gameSumStatsSuccess).catch(gameUi.gameStatsFailure);
	};

	var addGameAPIHandlers = function addGameAPIHandlers() {
	...
	module.exports = {
	  addGameAPIHandlers: addGameAPIHandlers,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameShow = function gameShow(gameId) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameIndexSuccess = function gameIndexSuccess(data) {
	  var newData = JSON.stringify(data.games, null, '\t');
	...
	var gameShowSuccess = function gameShowSuccess(data) {
	  var newData = JSON.stringify(data.game, null, '\t');
	  $('.get-stats-output').html(newData);
	};
	...
	var gameSumStatsSuccess = function gameSumStatsSuccess(data) {
	  app.sumData = data.games;

	  // get total games played by the user
	  var totalGamesPlayed = data.games.length;
	...
	module.exports = {
	  ...
	  gameSumStatsSuccess: gameSumStatsSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var checkRowWins = function checkRowWins(tileArray) {
	...
	// Called within tile click function
	var checkColWins = function checkColWins(tileArray) {
	...
	// Called within tile click function
	var checkDiagWins = function checkDiagWins(tileArray) {
	...
	// Called within tile click function
	var setOwner = function setOwner(tileID, tileIndex) {
	  if (globalJS.globalVars.activePlayer === 'x') {
	...
	var onTileClick = function onTileClick() {
	  ...
	  var tileID = '#' + tile;
	  var tileIndex = tile[tile.length - 1];
	...
	var onPlayNow = function onPlayNow() {
	  if (globalJS.globalVars.playerLogin === true && globalJS.globalVars.createGameSuccess === true) {
	    $('.board-item').css("pointer-events", "auto");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "7557162e670c5f0c2c53ec61e6cb952f.jpg";

/***/ },
/* 24 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "2ec8af25185d76120d0c909cdbf2762b.png";

/***/ },
/* 25 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "e91103ff4320df571f29a175b3dda5a4.png";
